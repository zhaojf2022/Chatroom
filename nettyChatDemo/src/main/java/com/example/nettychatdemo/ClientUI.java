...
public class ClientUI extends Application implements Serializable, EventHandler<ActionEvent>  {
    ...
    private Stage video_stage = UI.getVideoUi("服务端视频通话",video_image, this);
    private Stage audio_stage = UI.getAudioUi("服务端音频通话",audio_image, this);
    private STasks tasks = new STasks(this);
    private Stage stage;


    public void ServerTask() throws IOException {
